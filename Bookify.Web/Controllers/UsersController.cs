...
namespace Bookify.Web.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        public UsersController(IMapper mapper, RoleManager<IdentityRole> roleManager, UserManager<ApplicationUser> userManager, IEmailSender emailSender, IWebHostEnvironment webHostEnvironment, IEmailBodyBuilder emailBodyBuilder)
        {
            _mapper = mapper;
